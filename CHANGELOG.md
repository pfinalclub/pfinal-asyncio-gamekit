...
- **Workerman 版本兼容性**
  - 更新 `workerman/workerman` 版本约束为 `^4.1|^5.0`
  - 现在同时支持 Workerman v4.x 和 v5.x 版本
  - 解决了与已安装 Workerman v5.x 项目的依赖冲突问题
  - **注意**: 如果 `pfinalclub/asyncio` 尚未支持 Workerman v5，可能需要使用 `--with-all-dependencies` 选项安装
